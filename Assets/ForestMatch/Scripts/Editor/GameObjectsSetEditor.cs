...
namespace Mkey
{
    ...
    public class GameObjectsSetEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            //Tutorials
            ShowPropertiesBox(new string[] { "toolTutorials" }, true);
            ...
            ShowPropertiesBox(new string[] { "gridCellDisabledSprite" }, false);
            ...
            ShowPropertiesBoxFoldOut("Bombs", new string[] {
                ...
                //"dynamicMatchBombObjectVertical", "dynamicMatchBombObjectHorizontal", "dynamicMatchBombObjectRadial",
                 "dynamicClickBombObjectVertical", "dynamicClickBombObjectHorizontal", "dynamicClickBombObjectRadial",
                 "dynamicClickBombObjectDinamit", "dynamicClickBombObjectColor"//, "dynamicClickBombObjectButterfly"
            },
            ...
            //Falling
            ShowPropertiesBox(new string[] { "fallingObject" }, true);
