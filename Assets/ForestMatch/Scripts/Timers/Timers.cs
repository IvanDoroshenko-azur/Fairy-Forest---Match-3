...
namespace Mkey
{
    ...
    public class SessionTimer
    {
        ...
        public Action <int> TimeStartGameEvent;
        #endregion events
    ...
    public class GlobalTimer
    {
        ...
        public void Update()
        {
            ...
            {
                startGame = true;
                double a = (currentDT - startDT).TotalSeconds;
                if (a > 1860)
                {
                    dTime -= a - Mathf.Floor((float)(a / 1800)) * 1800;
                    TimeStartGameEvent?.Invoke(a / 60);
                }
                else
                    TimeStartGameEvent?.Invoke(0);
            }
        }
