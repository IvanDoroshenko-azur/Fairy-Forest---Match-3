...
namespace Mkey
{
    public class MatchGUIController : GuiController
    {
        ...
        public PopUpsController SalePrefab;
        public PopUpsController TutorialPrefab;
        public PopUpsController InventoryPrefab;
        ...
        public PopUpsController FortunePrefab;
        public PopUpsController NonFortunePrefab;
        public PopUpsController FindChestPrefab;
        ...
        public PopUpsController RatePrefab;
        public PopUpsController CheckNewPrefab;
        ...
        void Awake()
        {
            ...
            {
                Instance = this;
                Application.targetFrameRate = 60;// 35;
            }
        }
        ...
        public void ShowSale(Action closeCallback)
        {
            ShowPopUp(SalePrefab, null, closeCallback);
        }
        public void ShowTutorial(Action closeCallback)
        {
            ShowPopUp(TutorialPrefab, null, closeCallback);
        }
        ...
        public void ShowFortune(Action closeCallback)
        {
            ShowPopUp(FortunePrefab, null, closeCallback);
        }

        public void ShowInventory(Action closeCallback)
        {
            ShowPopUp(InventoryPrefab, null, closeCallback);
        }

        public void ShowFindChest(Action closeCallback)
        {
            ShowPopUp(FindChestPrefab, null, closeCallback);
        }
        public void ShowNonFortune(Action closeCallback)
        {
            ShowPopUp(NonFortunePrefab, null, closeCallback);
        }

        public void ShowRate(Action closeCallback)
        {
            ShowPopUp(RatePrefab, null, closeCallback);
        }

        public void ShowCheckNew(Action closeCallback)
        {
            ShowPopUp(CheckNewPrefab, null, closeCallback);
        }
