...
namespace Mkey
{
    ...
    public class WinController
    {
        ...
        public void CheckResult()
        {
            ...
            if (!targetAchieved && Result != GameResult.Win) // && mBoard.MbState != MatchBoardState.Collect 
            {
                ...
                else if ((!IsTimeLevel && MovesRest <= 0) && Result != GameResult.PreLoose)// && mBoard.NeedAlmostMessage() )//&& (Result != GameResult.PreLoose))
                {
            ...
            if (targetAchieved && Result != GameResult.Win)// && mBoard.MbState != MatchBoardState.Fill && mBoard.MbState != MatchBoardState.Collect && mBoard.MbState != MatchBoardState.Waiting)
            {
                if (MovesRest == 0)
                {
